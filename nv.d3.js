...
nv.models.gauge = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      gEnter.append('g').attr('class', 'nv-gauge');
      ...
      var gauge = d3.layout.pie()
          .sort(null)
          .value(function(d) { return d.disabled ? 0 : getY(d) })

      var slices = wrap.select('.nv-gauge').selectAll('.nv-slice')
          .data(gauge);
  ...
  chart.values = function(_) {
    nv.log("gauge.values() is no longer supported.");
    return chart;
  };
  ...
  chart.gaugeLabelsOutside = function(_) {
    if (!arguments.length) return gaugeLabelsOutside;
    gaugeLabelsOutside = _;
    return chart;
  };
...
nv.models.gaugeChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    var tooltipLabel = gauge.description()(e.point) || gauge.x()(e.point)
    var left = e.pos[0] + ( (offsetElement && offsetElement.offsetLeft) || 0 ),
        top = e.pos[1] + ( (offsetElement && offsetElement.offsetTop) || 0),
        y = gauge.valueFormat()(gauge.y()(e.point)),
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // display like a gauge chart
      gauge.startAngle(function(d) { return d.startAngle/1.5 -Math.PI/1.5; })
        .endAngle(function(d) { return d.endAngle/1.5 -Math.PI/1.5 ;});
  ...
  d3.rebind(chart, gauge, 'valueFormat', 'labelFormat', 'values', 'x', 'y', 'description', 'id', 'showLabels', 'donutLabelsOutside', 'gaugeLabelsOutside', 'labelType', 'donut', 'donutRatio', 'labelThreshold');
  chart.options = nv.utils.optionsFunc.bind(chart);
